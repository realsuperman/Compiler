...
%token  IDENTIFIER TYPE_IDENTIFIER FLOAT_CONSTANT INTEGER_CONSTANT 
		...
		MINUSMINUS AMP BAR BARBAR AMPAMP ARROW 
...
declaration
	: declaration_specifiers init_declarator_list SEMICOLON {$$=setDeclaratorListSpecifier($2,$1);}
	;
...
compound_statement
	: LR {$$=current_id;current_level++;} declaration_list
	statement_list RR {checkForwardReference();$$=makeNode(N_STMT_COMPOUND,$3,NIL,$4); current_id=$2;current_level--;}
	;
...
logical_and_expression
	...
	| logical_and_expression AMPAMP inclusive_or_expression {$$=makeNode(N_EXP_AND,$1,NIL,$3);}
	;
